...
const DelhiCapitals = () => {
    ...
    const filterRole = (role) => {
        let updateRole = DC.filter((pRole) => {
  ...
  return (
    <>
        ...
        <div className="container-fluid bg-dark text-light d-flex flex-wrap justify-content-around align-items-center fixed-top" style={{ backgroundImage: "linear-gradient(to right, #5757f1 0%, #2c14f1 50%, #e70f0f 100%)"}}>
                <img className='img-fluid me-5 p-1' src="https://documents.iplt20.com/ipl/DC/Logos/LogoOutline/DCoutline.png" alt="" height={80} width={80}/>
                <h2 className='ms-5'>TATA IPL 2024 - DELHI CAPITALS (DC)</h2>
                <div className="d-flex flex-wrap justify-content-around align-items-center">
                    <button className='btn btn-light ms-4'>Home</button>
                    <button className='btn btn-light ms-4'><a className='text-decoration-none text-dark' href="https://www.delhicapitals.in/" target='_blank'>Official Team Site 
            ...
            <div className="carousel slide" id="captions1" data-bs-ride="carousel" data-bs-interval="3000">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="https://fantasykhiladi.com/wp-content/uploads/2024/03/Delhi-Capitals-2024.webp" className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item">
                        <img src="https://assets.khelnow.com/news/uploads/2024/03/Delhi-Capitals-DC-IPL-2024.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                DC Match Huddle
                            </button>
                    ...
                    <div className="carousel-item">
                        <img src="https://www.india.com/wp-content/uploads/2022/03/pjimage-2022-03-22T215033.038.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                Delhi Squad Announcement
                            </button>
                        </div>
                    </div>
                    <div className="carousel-item">
                        <img src="https://img.jagranjosh.com/images/2022/March/2632022/delhi-capital-dc-ipl-2022-schedule-squad.webp" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                Delhi Capitals
                            </button>
                    ...
                    <div className="carousel-item">
                        <img src="https://d16f573ilcot6q.cloudfront.net/wp-content/uploads/2024/03/PSL-16-1.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                Delhi Capitals
                            </button>
        ...
        <div className="container-fluid d-flex flex-wrap justify-content-center mt-4">
                <button className='btn btn-outline-dark' onClick={() => {setDc(DC)}}>ALL TEAM</button>
          ...
          dc.map((cPlayer) => {
            ...
            return (
                <div className="card bg-light m-3" style={{width:"20%"}} key={playerID}>
                    <h5 className="card-header text-center text-light fw-bold p-3 team-dc-header">Player Details</h5>
