...
const GujratTitans = () => {
    const [gt, setGt] = useState(GT);

    const filterRole = (role) => {
        let updateRole = GT.filter((pRole) => {
  ...
  return (
    <>
        ...
        <div className="container-fluid bg-dark text-light d-flex flex-wrap justify-content-around align-items-center fixed-top" style={{ backgroundImage: "linear-gradient(to right, #1B2133 100%"}}>
                <img className='img-fluid me-5 p-1' src="https://documents.iplt20.com/ipl/GT/Logos/Logooutline/GToutline.png" alt="" height={80} width={80}/>
                <h2 className='ms-5'>TATA IPL 2024 - GUJRAT TITANS (GT)</h2>
                <div className="d-flex flex-wrap justify-content-around align-items-center">
                    <button className='btn btn-light ms-4'>Home</button>
                    <button className='btn btn-light ms-4'><a className='text-decoration-none text-dark' href="https://www.gujarattitansipl.com/" target='_blank'>Official Team Site 
            ...
            <div className="carousel slide" id="captions1" data-bs-ride="carousel" data-bs-interval="3000">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="https://cricxtasy.com/static/c1e/client/95405/uploaded/5926882deed1d4b31a6be14492072cc5.jpg" className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item">
                        <img src="https://circleofcricket.com/post_image/post_image_9f1cb85.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL WINNER 2022
                    ...
                    <div className="carousel-item">
                        <img src="https://www.wisden.com/static-assets/waf-images/8e/21/50/16-9/596617_Leadimage40.png?v=23.06&w=600" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                    ...
                    <div className="carousel-item">
                        <img src="https://akm-img-a-in.tosshub.com/indiatoday/images/breaking_news/202404/shubman-gill-243057651-16x9.jpg?VersionId=WQS5PQZ0LQm.41X1fKwbBGTlpKYxi6mW" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                The Captain Knock by Shubhman Gill
                            </button>
                        </div>
                    </div>
                    <div className="carousel-item">
                        <img src="https://images.news18.com/ibnlive/uploads/2024/03/ipl-2024_gt-vs-mi-live-2024-03-0ae64c8065d123a438df2868f6d0d5a6.jpg?impolicy=website&width=640&height=480" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                The Wicket Taker Mohit Sharma!
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div className="container-fluid d-flex flex-wrap justify-content-center mt-4">
                <button className='btn btn-outline-dark' onClick={() => {setGt(GT)}}>ALL TEAM</button>
          ...
          gt.map((cPlayer) => {
            ...
            return (
                <div className="card bg-light m-3" style={{width:"20%"}} key={playerID}>
                    <h5 className="card-header text-center text-light fw-bold p-3 team-gt-header">Player Details</h5>
