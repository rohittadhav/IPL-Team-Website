...
const ChennaiSuperKings = () => {
    const [csk, setCsk] = useState(CSK);

    const filterRole = (role) => {
        let updateRole = CSK.filter((pRole) => {
  ...
  return (
    <>
        ...
        <div className="container-fluid bg-dark text-light d-flex flex-wrap justify-content-around align-items-center fixed-top" style={{ background: "linear-gradient(to right, #ede012 0%, #fbff22 100%)" }}>
                <img className='img-fluid me-5 p-1' src="https://documents.iplt20.com/ipl/CSK/logos/Logooutline/CSKoutline.png" alt="" height={80} width={80}/>
                <h2 className='ms-5 text-dark'>TATA IPL 2024 - CHENNAI SUPER KINGS (CSK)</h2>
                <div className="d-flex flex-wrap justify-content-around align-items-center">
                    <button className='btn btn-dark ms-4'><a className='text-decoration-none text-light' href="#">Home</a></button>
                    <button className='btn btn-dark ms-4'><a className='text-decoration-none text-light' href="https://www.chennaisuperkings.com/" target='_blank'>Official Team Site 
            ...
            <div className="carousel slide" id="captions1" data-bs-ride="carousel" data-bs-interval="3000">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="https://thehawk.s3.ap-south-1.amazonaws.com/CSK%20Team.webp" className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item">
                        <img src="https://images.hindustantimes.com/rf/image_size_630x354/HT/p2/2019/03/16/Pictures/_f6989134-47c8-11e9-9b94-c272560e6ac5.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL WINNER 2010
                                <svg className='ms-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trophy-fill" viewBox="0 0 16 16">
                    ...
                    <div className="carousel-item">
                        <img src="https://www.espncricinfo.com/db/PICTURES/CMS/133500/133522.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL WINNER 2011
                                <svg className='ms-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trophy-fill" viewBox="0 0 16 16">
                    ...
                    <div className="carousel-item">
                        <img src="https://images.firstpost.com/wp-content/uploads/2018/05/Final-5.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL WINNER 2018
                                <svg className='ms-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trophy-fill" viewBox="0 0 16 16">
                    ...
                    <div className="carousel-item">
                        <img src="https://www.arabnews.com/sites/default/files/styles/n_670_395/public/2021/10/16/2862416-1905191691.png?itok=fLRQQm6n" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL WINNER 2021
                                <svg className='ms-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trophy-fill" viewBox="0 0 16 16">
                    ...
                    <div className="carousel-item">
                        <img src="https://assets.khelnow.com/news/uploads/2023/06/IPL-2023-Champions-Chennai-Super-Kings.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL WINNER 2023
                                <svg className='ms-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trophy-fill" viewBox="0 0 16 16">
        ...
        <div className="container-fluid d-flex flex-wrap justify-content-center mt-4">
                <button className='btn btn-outline-dark' onClick={() => {setCsk(CSK)}}>ALL TEAM</button>
