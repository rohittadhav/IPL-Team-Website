...
const SunrisersHyderabad = () => {
    const [srh, setSrh] = useState(SRH);

    const filterRole = (role) => {
        let updateRole = SRH.filter((pRole) => {
  ...
  return (
    <>
        ...
        <div className="container-fluid bg-dark text-light d-flex flex-wrap justify-content-around align-items-center fixed-top" style={{ backgroundImage: "linear-gradient(90deg, rgba(248,112,27,1) 34%, rgba(220,89,13,1) 74%)"}}>
                <img className='img-fluid me-5 p-1' src="https://documents.iplt20.com/ipl/SRH/Logos/Logooutline/SRHoutline.png" alt="" height={80} width={80}/>
                <h2 className='ms-5'>TATA IPL 2024 - SUNRISERS HYDERABAD (SRH)</h2>
                <div className="d-flex flex-wrap justify-content-around align-items-center">
                    <button className='btn btn-light ms-4'>Home</button>
                    <button className='btn btn-light ms-4'><a className='text-decoration-none text-dark' href="https://www.sunrisershyderabad.in/" target='_blank'>Official Team Site 
            ...
            <div className="carousel slide" id="captions1" data-bs-ride="carousel" data-bs-interval="3000">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="https://www.dreamteamcric.com/wp-content/uploads/SRH-Playing-11-2024.jpg" className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item">
                        <img src="https://www.cricketcountry.com/wp-content/uploads/2016/06/000_BC29I-1.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL WINNER 2016
                    ...
                    <div className="carousel-item">
                        <img src="https://crickettimes.com/wp-content/uploads/2024/03/Bhuvneshwar-Kumar-Pat-Cummins-and-Heinrich-Klaasen.webp" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                SRH Dynamic Trio Ready to Roar
                            </button>
                        </div>
                    </div>
                    <div className="carousel-item">
                        <img src="https://static.cricketaddictor.com/images/2024/Travis%20Head-Abhishek%20Sharma%20SRH%20IPL%202024.webp?q=80" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                SRH Destruction Duo
                            </button>
                    ...
                    <div className="carousel-item">
                        <img src="https://www.hindustantimes.com/ht-img/img/2024/04/21/550x309/India-IPL-Cricket-17_1713660905838_1713660936469.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                SRH into the Finals of 2024
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div className="container-fluid d-flex flex-wrap justify-content-center mt-4">
                <button className='btn btn-outline-dark' onClick={() => {setSrh(SRH)}}>ALL TEAM</button>
          ...
          srh.map((cPlayer) => {
            ...
            return (
                <div className="card bg-light m-3" style={{width:"20%"}} key={playerID}>
                    <h5 className="card-header text-center text-light fw-bold p-3 team-srh-header">Player Details</h5>
