...
const PunjabKings = () => {
    ...
    const filterRole = (role) => {
        let updateRole = PK.filter((pRole) => {
  ...
  return (
    <>
        ...
        <div className="container-fluid bg-dark text-light d-flex flex-wrap justify-content-around align-items-center fixed-top" style={{ backgroundImage: "linear-gradient(90deg, rgba(248,27,27,1) 34%, rgba(220,13,13,1) 74%)"}}>
                <img className='img-fluid me-5 p-1' src="https://documents.iplt20.com/ipl/PBKS/Logos/Logooutline/PBKSoutline.png" alt="" height={80} width={80}/>
                <h2 className='ms-5'>TATA IPL 2024 - PUNJAB KINGS (PK)</h2>
                <div className="d-flex flex-wrap justify-content-around align-items-center">
                    <button className='btn btn-light ms-4'>Home</button>
                    <button className='btn btn-light ms-4'><a className='text-decoration-none text-dark' href="https://www.punjabkingsipl.in/" target='_blank'>Official Team Site 
            ...
            <div className="carousel slide" id="captions1" data-bs-ride="carousel" data-bs-interval="3000">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="https://www.dreamteamcric.com/wp-content/webp-express/webp-images/doc-root/wp-content/uploads/PBKS-Playing-11-2024.jpg.webp" className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item">
                        <img src="https://images.indianexpress.com/2023/12/Punjab-Kings.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                PK Match Huddle
                            </button>
                    ...
                    <div className="carousel-item">
                        <img src="https://static.toiimg.com/thumb/msid-108551463,width-1280,height-720,imgsize-186382,resizemode-6,overlay-toi_sw,pt-32,y_pad-40/photo.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                IPL 2024 Punjab Kings Jersey Revil
                            </button>
                        </div>
                    </div>
                    <div className="carousel-item">
                        <img src="https://images.news18.com/ibnlive/uploads/2024/03/pbks-jersey-2024-feature-2024-03-e04726ad340d013dd606d7f6edf6f022.jpg?impolicy=website&width=640&height=480" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                Punjab De-Sher
                            </button>
                    ...
                    <div className="carousel-item">
                        <img src="https://media.assettype.com/freepressjournal/2024-03/454b536d-23b8-44d2-b2c3-5a168e195002/Punjab_Kings.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                            <button className='btn btn-dark'>
                                Punjab Kings
                            </button>
        ...
        <div className="container-fluid d-flex flex-wrap justify-content-center mt-4">
                <button className='btn btn-outline-dark' onClick={() => {setPk(PK)}}>ALL TEAM</button>
          ...
          pk.map((cPlayer) => {
            ...
            return (
                <div className="card bg-light m-3" style={{width:"20%"}} key={playerID}>
                    <h5 className="card-header text-center text-light fw-bold p-3 team-pk-header">Player Details</h5>
